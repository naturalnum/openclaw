...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    files: "Browse files and folders in the working directory.",
  ...
  files: {
    ...
    uploadStatus: {
      uploading: "Uploading",
      preparing: "Preparing...",
      progressLoaded: "Uploaded {loaded}",
      progressDetailed: "Uploaded {loaded} / {total}",
    },
    preview: {
      title: "Preview",
      empty: "Select a file to preview it here.",
      folderHint: "Double-click this folder to open it.",
      unavailable: "Preview unavailable for this file type.",
    },
    prompts: {
