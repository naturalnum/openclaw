...
import {
  ...
  type SkillsHubCatalogParams,
  SkillsHubCatalogParamsSchema,
...
export const validateSkillsHubCatalogParams = ajv.compile<SkillsHubCatalogParams>(
  SkillsHubCatalogParamsSchema,
);
