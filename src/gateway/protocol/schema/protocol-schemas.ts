...
import {
  ...
  ConnectorCapabilitiesListResultSchema,
  ConnectorCapabilitySchema,
  ConnectorCatalogGetParamsSchema,
  ConnectorCatalogListParamsSchema,
  ConnectorCatalogListResultSchema,
  ConnectorFieldDefinitionSchema,
  ConnectorInstanceDeleteParamsSchema,
  ConnectorInstanceDeleteResultSchema,
  ConnectorInstanceGetParamsSchema,
  ConnectorInstanceMutationResultSchema,
  ConnectorInstancePolicySchema,
  ...
  ConnectorInvokeResultSchema,
  ConnectorProviderDefinitionSchema,
  ConnectorToolSummarySchema,
  ConnectorToolsListParamsSchema,
  ConnectorToolsListResultSchema,
} from "./connectors.js";
import {
  CronAddParamsSchema,
  CronJobSchema,
...
import {
  SkillsRegistryCategorySchema,
  SkillsRegistryCatalogItemSchema,
  SkillsRegistryInstallArchiveParamsSchema,
  SkillsRegistryInstallArchiveResultSchema,
  SkillsRegistryInstallParamsSchema,
  SkillsRegistryInstallResultSchema,
  SkillsRegistryInstallStateSchema,
  SkillsRegistryListParamsSchema,
  SkillsRegistryListResultSchema,
  SkillsRegistryPaginationSchema,
  SkillsRegistryUninstallParamsSchema,
  SkillsRegistryUninstallResultSchema,
...
export const ProtocolSchemas = {
  ...
  SkillsRegistryCategory: SkillsRegistryCategorySchema,
  SkillsRegistryCatalogItem: SkillsRegistryCatalogItemSchema,
  SkillsRegistryInstallState: SkillsRegistryInstallStateSchema,
  SkillsRegistryPagination: SkillsRegistryPaginationSchema,
  SkillsRegistryListParams: SkillsRegistryListParamsSchema,
  SkillsRegistryListResult: SkillsRegistryListResultSchema,
  SkillsRegistryInstallParams: SkillsRegistryInstallParamsSchema,
  SkillsRegistryInstallResult: SkillsRegistryInstallResultSchema,
  SkillsRegistryInstallArchiveParams: SkillsRegistryInstallArchiveParamsSchema,
  SkillsRegistryInstallArchiveResult: SkillsRegistryInstallArchiveResultSchema,
  SkillsRegistryUninstallParams: SkillsRegistryUninstallParamsSchema,
  SkillsRegistryUninstallResult: SkillsRegistryUninstallResultSchema,
  ...
  ConnectorFieldDefinition: ConnectorFieldDefinitionSchema,
  ConnectorActionDefinition: ConnectorActionDefinitionSchema,
  ConnectorProviderDefinition: ConnectorProviderDefinitionSchema,
  ConnectorCatalogListParams: ConnectorCatalogListParamsSchema,
  ConnectorCatalogGetParams: ConnectorCatalogGetParamsSchema,
  ConnectorCatalogListResult: ConnectorCatalogListResultSchema,
  ConnectorInstancePolicy: ConnectorInstancePolicySchema,
  ConnectorInstance: ConnectorInstanceSchema,
  ConnectorInstancesListParams: ConnectorInstancesListParamsSchema,
  ConnectorInstanceGetParams: ConnectorInstanceGetParamsSchema,
  ConnectorInstanceUpsertParams: ConnectorInstanceUpsertParamsSchema,
  ConnectorInstanceDeleteParams: ConnectorInstanceDeleteParamsSchema,
  ConnectorInstanceSetEnabledParams: ConnectorInstanceSetEnabledParamsSchema,
  ConnectorInstancesListResult: ConnectorInstancesListResultSchema,
  ConnectorInstanceMutationResult: ConnectorInstanceMutationResultSchema,
  ConnectorInstanceDeleteResult: ConnectorInstanceDeleteResultSchema,
  ConnectorCapabilitiesListParams: ConnectorCapabilitiesListParamsSchema,
  ConnectorCapability: ConnectorCapabilitySchema,
  ConnectorCapabilitiesListResult: ConnectorCapabilitiesListResultSchema,
  ConnectorToolSummary: ConnectorToolSummarySchema,
  ConnectorToolsListParams: ConnectorToolsListParamsSchema,
  ConnectorToolsListResult: ConnectorToolsListResultSchema,
  ConnectorInvokeParams: ConnectorInvokeParamsSchema,
  ConnectorInvokeResult: ConnectorInvokeResultSchema,
