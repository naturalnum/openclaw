...
- Canonical template document: `./skills/tech-report/references/纵向科技项目技术报告编写模板-2023版（新模板）.docx`
- Canonical rule file: `./skills/tech-report/references/技术报告规范要点.md`
...
```bash
python3 skills/tech-report/scripts/extract_source_text.py \
  --input ./input.pdf \
...
```bash
python3 skills/tech-report/scripts/generate_exact_toc_report.py \
  --template ./skills/tech-report/references/纵向科技项目技术报告编写模板-2023版（新模板）.docx \
  --source ./input.pdf \
...
```bash
python3 skills/tech-report/scripts/inspect_template_docx.py \
  --input ./skills/tech-report/references/纵向科技项目技术报告编写模板-2023版（新模板）.docx \
...
```bash
python3 skills/tech-report/scripts/audit_template_docx.py \
  --input ./skills/tech-report/references/纵向科技项目技术报告编写模板-2023版（新模板）.docx \
...
```bash
python3 skills/tech-report/scripts/suggest_style_mapping.py \
