...
def main() -> int:
    ...
    plan = {
        ...
        "minimax_docx_handoff": {
            ...
            "required_reads": [
                ...
                "skills/tech-report/SKILL.md",
                "skills/tech-report/references/template-format-rules.md",
                "skills/tech-report/references/fixed-template-profile.md",
            ],
        },
        "template_summary": {
    ...
    preview_prompt = f"""Use the tech-report skill together with minimax-docx.
Template: {manifest['template']}
Source: {manifest['source']}
