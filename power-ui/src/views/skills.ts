...
import { formatRelativeTimestamp } from "../../../ui/src/ui/format.ts";
      ...
      ${deduped.map(
        (page, index) => html`
          ${index > 0 && deduped[index - 1] !== page - 1
            ? html` <span class="muted" style="align-self: center">…</span> `
            : nothing}
          <button
...
function renderCard(props: SkillsProps, item: SkillsRegistryCatalogItem) {
  ...
  return html`
    ...
    >
      <div
        class="row"
        style="justify-content: space-between; align-items: center; gap: 16px; flex-wrap: nowrap;"
      >
      ...
      <div style="display: flex; flex-direction: column; gap: 18px;">
          ...
          <div class="row" style="gap: 8px; flex-wrap: wrap;">
            ...
            >
              ...
              <input
                ...
                style="position: fixed; width: 1px; height: 1px; padding: 0; margin: -1px; border: 0; overflow: hidden; clip: rect(0 0 0 0); clip-path: inset(100%); white-space: nowrap; opacity: 0; pointer-events: none;"
        ...
        ${props.loading && props.items.length === 0
          ...
          : props.items.length === 0
            ...
            : html`
                <div
                  style="display: grid; grid-template-columns: repeat(auto-fill, minmax(min(100%, 320px), 320px)); justify-content: start; gap: 16px;"
                >
